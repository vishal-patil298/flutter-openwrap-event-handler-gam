...
class GAMInterstitialScreen extends StatefulWidget {
  const GAMInterstitialScreen({Key? key}) : super(key: key);

  @override
  State<GAMInterstitialScreen> createState() => _GAMInterstitialScreen();
}

class _GAMInterstitialScreen extends State<GAMInterstitialScreen> {
  ...
  void initState() {
    ...
    // you use separate event handler objects to create each insterstitial ad.
    // For example, The code below creates an event handler for GAM ad server.
    final GAMInterstitialEventHandler eventHandler =
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('GAM Interstitial Ad'),
      ),
      body: Container(
