...
class GAMMRECDisplayScreen extends StatefulWidget {
  const GAMMRECDisplayScreen({Key? key}) : super(key: key);

  @override
  State<GAMMRECDisplayScreen> createState() => _GAMMRECDisplayScreen();
}

class _GAMMRECDisplayScreen extends State<GAMMRECDisplayScreen> {
  ...
  void initState() {
    ...
    final List<AdSize> adSizes = [AdSize.mediumRectangle];
    ...
    final GAMBannerEventHandler eventHandler =
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('GAM MREC Display'),
      ),
      body: Center(
...
class _BannerAdListener implements POBBannerAdListener {
  final String _tag = 'POBBannerViewListener';
